...
class SidePanelFragment(ttk.Frame):
    ...
    def create_content(self):
        self.top_padding = ttk.Label(self)
        self.top_padding.grid(pady=50)

        self.button1 = ttk.Button(self, text="All recipes", command=self.on_recipes_button_clicked)
        self.button1.grid(row=1, sticky=tk.W+tk.E, padx=self.btn_ipadx, pady=self.btn_pady, ipadx=self.btn_ipadx)

        self.button2 = ttk.Button(self, text="Create new recipe", command=self.on_create_new_recipe_button_clicked)
        self.button2.grid(row=2, sticky=tk.W+tk.E, padx=self.btn_ipadx, pady=self.btn_pady, ipadx=self.btn_ipadx)
    ...
    def on_create_new_recipe_button_clicked(self, *args):
        ...
        self.parent.show_create_new_recipe()
